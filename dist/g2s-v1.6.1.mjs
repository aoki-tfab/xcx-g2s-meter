...
var en = {
	...
	"g2s.analogLevelA1": "value of AnalogA(A1)",
	...
	"g2s.digitalLevelB2": "value of DigitalB(B2)",
	"g2s.digitalConnector.prefix": "Digital",
	"g2s.digitalLevelMenu.low": "0",
	"g2s.digitalLevelMenu.high": "1",
	...
	"g2s.neoPixelShiftColor": "color LED [CONNECTOR] shift color settings by [N] ([LOOP_MODE])",
	"g2s.neoPixelShiftColor.LOOP_MODE.ENABLE_LOOP": "loop",
	"g2s.neoPixelShiftColor.LOOP_MODE.DISABLE_LOOP": "no loop",
	"g2s.neoPixelColorMenu.red": "red",
	"g2s.neoPixelColorMenu.orange": "orange",
	"g2s.neoPixelColorMenu.yellow": "yellow",
	"g2s.neoPixelColorMenu.green": "green",
	"g2s.neoPixelColorMenu.blue": "blue",
	"g2s.neoPixelColorMenu.indigo": "indigo",
	"g2s.neoPixelColorMenu.violet": "violet",
	"g2s.neoPixelColorMenu.purple": "purple",
	"g2s.neoPixelColorMenu.white": "white",
	"g2s.neoPixelColorMenu.black": "black",
	"g2s.neoPixelColorMenu.rainbow": "rainbow",
	"g2s.neoPixelColor": "color LED color R [RED] G [GREEN] B [BLUE]",
	"g2s.neoPixelColorMode": "color LED [MODE]",
	"g2s.neoPixelColorMode.rainbow": "rainbow",
	...
	"g2s.shareGroupIDDialog.message": "set communication group ID",
	"g2s.shareGroupIDDialog.cancel": "cancel",
	"g2s.shareGroupIDDialog.set": "set",
	...
	"g2s.askGenerativeAI": "generative AI ask [PROMPT] [TARGET]",
	"g2s.askGenerativeAILocale": "en",
	"g2s.askGenerativeAIDefault": "What is this? (Within 100 words)",
	"g2s.askGenerativeAITargetStage": "about stage",
	"g2s.askGenerativeAICannotConnect": "Cannot connect Generative AI",
	"g2s.askGenerativeAIBoardNotConnected": "The board is not connected",
	"g2s.connectSpreadsheetAppend": "spreadsheet append [VALUE] to URL [URL]",
	"g2s.connectSpreadsheetWrite": "spreadsheet write [VALUE] to URL [URL] at column [COLUMN], row [ROW]",
	"g2s.connectSpreadsheetRead": "spreadsheet value at column [COLUMN], row [ROW] in URL [URL]",
	"g2s.connectSendLine": "LINE send [MESSAGE] to token [DESTINATION]",
	"g2s.connectSendMail": "email send [MESSAGE] to address [DESTINATION]",
	"g2s.connectCannotConnectServer": "Cannot connect AkaDako Connect server"
};
var ja = {
	"g2s.name": "AkaDako",
	...
	"g2s.digitalLevelB2": "デジタルB(B2)の値",
	...
	"g2s.neoPixelFillColor": "カラーLED[CONNECTOR]の全てを[COLOR]色で明るさ[BRIGHTNESS]に設定する",
	"g2s.neoPixelShiftColor": "カラーLED[CONNECTOR]を[N]個分設定をずらす([LOOP_MODE])",
	"g2s.neoPixelShiftColor.LOOP_MODE.ENABLE_LOOP": "回転する",
	"g2s.neoPixelShiftColor.LOOP_MODE.DISABLE_LOOP": "回転しない",
	"g2s.neoPixelColorMenu.red": "赤",
	"g2s.neoPixelColorMenu.orange": "だいだい",
	"g2s.neoPixelColorMenu.yellow": "黄",
	"g2s.neoPixelColorMenu.green": "緑",
	"g2s.neoPixelColorMenu.blue": "青",
	"g2s.neoPixelColorMenu.indigo": "あい",
	"g2s.neoPixelColorMenu.violet": "すみれ",
	"g2s.neoPixelColorMenu.purple": "紫",
	"g2s.neoPixelColorMenu.white": "白",
	"g2s.neoPixelColorMenu.black": "黒",
	"g2s.neoPixelColorMenu.rainbow": "レインボー",
	"g2s.neoPixelColor": "カラーLED RGB 赤[RED] 緑[GREEN] 青[BLUE]",
	"g2s.neoPixelColorMode": "カラーLED [MODE]",
	"g2s.neoPixelColorMode.rainbow": "虹色",
	...
	"g2s.shareGroupIDDialog.message": "通信グループID",
	"g2s.shareGroupIDDialog.cancel": "キャンセル",
	"g2s.shareGroupIDDialog.set": "決定",
	"g2s.connectToShareServer": "ネットに接続する",
	"g2s.isShareServerConnected": "ネットに接続している",
	...
	"g2s.askGenerativeAI": "生成AIに[TARGET][PROMPT]と聞く",
	"g2s.askGenerativeAILocale": "ja",
	"g2s.askGenerativeAIDefault": "100文字以内で説明して",
	"g2s.askGenerativeAITargetStage": "ステージについて",
	"g2s.askGenerativeAICannotConnect": "生成AIに接続できません",
	"g2s.askGenerativeAIBoardNotConnected": "ボードが接続されていないため利用することができません",
	"g2s.connectSpreadsheetAppend": "スプレッドシート URL[URL]に[VALUE]を記録",
	"g2s.connectSpreadsheetWrite": "スプレッドシート URL[URL]の[COLUMN]列[ROW]行に[VALUE]を書き込む",
	"g2s.connectSpreadsheetRead": "スプレッドシート URL[URL]の[COLUMN]列[ROW]行の値",
	"g2s.connectSendLine": "LINE トークン[DESTINATION]に[MESSAGE]を送る",
	"g2s.connectSendMail": "メール アドレス[DESTINATION]に[MESSAGE]を送る",
	"g2s.connectCannotConnectServer": "AkaDako Connectのサーバーに接続できませんでした"
};
var translations = {
	en: en,
	ja: ja,
	...
	"g2s.boardStateChanged": "ボードが[STATE]とき",
	"g2s.analogConnector.prefix": "アナログ",
	"g2s.analogLevelA1": "アナログA(A1)のあたい",
	...
	"g2s.digitalLevelB2": "デジタルB(B2)のあたい",
	"g2s.digitalConnector.prefix": "デジタル",
	"g2s.digitalLevelMenu.low": "0",
	"g2s.digitalLevelMenu.high": "1",
	"g2s.inputBiasSet": "[PIN]を[BIAS]",
	...
	"g2s.neoPixelFillColor": "カラーLED[CONNECTOR]のすべてを[COLOR]いろであかるさ[BRIGHTNESS]にせっていする",
	"g2s.neoPixelShiftColor": "カラーLED[CONNECTOR]を[N]こぶんずらす([LOOP_MODE])",
	"g2s.neoPixelShiftColor.LOOP_MODE.ENABLE_LOOP": "かいてんする",
	"g2s.neoPixelShiftColor.LOOP_MODE.DISABLE_LOOP": "かいてんしない",
	"g2s.neoPixelColorMenu.red": "あか",
	"g2s.neoPixelColorMenu.orange": "だいだい",
	"g2s.neoPixelColorMenu.yellow": "き",
	"g2s.neoPixelColorMenu.green": "みどり",
	"g2s.neoPixelColorMenu.blue": "あお",
	"g2s.neoPixelColorMenu.indigo": "あい",
	"g2s.neoPixelColorMenu.violet": "すみれ",
	"g2s.neoPixelColorMenu.purple": "むらさき",
	"g2s.neoPixelColorMenu.white": "しろ",
	"g2s.neoPixelColorMenu.black": "くろ",
	"g2s.neoPixelColorMenu.rainbow": "れいんぼー",
	"g2s.neoPixelColor": "カラーLED RGB あか[RED] みどり[GREEN] あお[BLUE]",
	"g2s.neoPixelColorMode": "カラーLED [MODE]",
	"g2s.neoPixelColorMode.rainbow": "にじいろ",
	...
	"g2s.shareGroupIDDialog.message": "つうしんグループID",
	"g2s.shareGroupIDDialog.cancel": "キャンセル",
	"g2s.shareGroupIDDialog.set": "けってい",
	"g2s.connectToShareServer": "ネットにせつぞくする",
	"g2s.isShareServerConnected": "ネットにせつぞくしている",
	...
	"g2s.askGenerativeAI": "せいせいAIに[TARGET][PROMPT]ときく",
	"g2s.askGenerativeAILocale": "ja-Hira",
	"g2s.askGenerativeAIDefault": "100もじいないでせつめいして",
	"g2s.askGenerativeAITargetStage": "ステージについて",
	"g2s.askGenerativeAICannotConnect": "せいせいAIにせつぞくできません",
	"g2s.askGenerativeAIBoardNotConnected": "ボードがせつぞくされていないためりようすることができません",
	"g2s.connectSpreadsheetAppend": "スプレッドシート URL[URL]に[VALUE]をきろく",
	"g2s.connectSpreadsheetWrite": "スプレッドシート URL[URL]の[COLUMN]れつ[ROW]ぎょうに[VALUE]をかきこむ",
	"g2s.connectSpreadsheetRead": "スプレッドシート URL[URL]の[COLUMN]れつ[ROW]ぎょうのあたい",
	"g2s.connectSendLine": "LINE トークン[DESTINATION]に[MESSAGE]をおくる",
	"g2s.connectSendMail": "メール アドレス[DESTINATION]に[MESSAGE]をおくる",
	"g2s.connectCannotConnectServer": "AkaDako Connectのサーバーにせつぞくできませんでした"
}
};

var img = "data:image/png;base64,";
...
function fromValue(val, unsigned) {
  ...
  if (typeof val === 'string') return fromString$2(val, unsigned); // Throws for non-objects, converts non-instanceof Long:
...
var SYSEX_RESPONSE = (_SYSEX_RESPONSE = {}, _defineProperty(_SYSEX_RESPONSE, QUERY_FIRMWARE, function (board) {
  ...
  var buffer = Buffer$1.alloc(Math.round((length - 4) / 2));
  var byte = 0;
  var offset = 0;
  ...
  board.emit("string", Buffer$1.from(board.buffer.slice(2, -1)).toString().replace(/\0/g, ""));
...
var Firmata$1 = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(Firmata, [{
    ...
    value: function servoConfig(pin, min, max) {
      if (_typeof(pin) === "object" && pin !== null) {
        var temp = pin;
        pin = temp.pin;
        min = temp.min;
        max = temp.max;
    ...
    value: function sendString(string) {
      var bytes = Buffer$1.from("".concat(string, "\0"), "utf8");
      var data = [];
    ...
    value: function i2cWrite(address, registerOrData, inBytes) {
      ...
      var bytes = Buffer$1.from([registerOrData].concat(inBytes));
...
function writeToTransport(board, data) {
  board.pending++;
  board.transport.write(Buffer$1.from(data), function () {
...
var util = require$$1;
var debug$1 = browser.exports('serialport/stream'); //  VALIDATION
...
function allocNewReadPool(poolSize) {
  var pool = Buffer$1.allocUnsafe(poolSize);
  pool.used = 0;
  return pool;
}
/**
...
SerialPort.prototype._writev = function (data, callback) {
  ...
  this._write(Buffer$1.concat(dataV), null, callback);
};
/**
...
var MidiDakoTransport = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(MidiDakoTransport, [{
    ...
    value: function convertToSend(buff) {
      ...
      if (data.length === 3 && data[0] === 0xF0 && data[2] === 0xF7) {
        // one byte SysEx
...
var throttledQueue = /*@__PURE__*/getDefaultExportFromCjs(throttledQueue$1.exports);
  ...
  _createClass(AkaDakoBoard, [{
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                _context3.next = 5;
                return this.openSerialPort(options);
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            ...
                            availablePorts = [];
                            _iterator = _createForOfIteratorHelper$2(portFilters);
                            _context4.prev = 4;
    ...
    value: function neoPixelConfigStrip(pin, length) {
      ...
      if (oldStrip != null) {
        ...
        this.neoPixel.push(Object.assign(oldStrip, {
          length: length
        }));
      } else {
        this.neoPixel = this.neoPixel.filter(function (aStrip) {
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                ...
                oldColors = strip && strip.colors || Array(length);
                ...
                newColors = _toConsumableArray(oldColors).map(colorMapFn);
                index = 0;
    ...
    value: function () {
      ...
      function neoPixelClearAll() {
        return _neoPixelClearAll.apply(this, arguments);
      }

      return neoPixelClearAll;
    }()
    /**
    ...
    key: "neoPixelGetColors",
    value: function neoPixelGetColors(pin) {
...
var CHIP_ID_BMP280 = 0x58;
var CHIP_ID_BME280 = 0x60; // registers

var BME280_REG_DIG_T1 = 0x88;
var BME280_REG_DIG_T2 = 0x8A;
var BME280_REG_DIG_T3 = 0x8C;
var BME280_REG_DIG_P1 = 0x8E;
var BME280_REG_DIG_P2 = 0x90;
var BME280_REG_DIG_P3 = 0x92;
var BME280_REG_DIG_P4 = 0x94;
var BME280_REG_DIG_P5 = 0x96;
var BME280_REG_DIG_P6 = 0x98;
var BME280_REG_DIG_P7 = 0x9A;
var BME280_REG_DIG_P8 = 0x9C;
var BME280_REG_DIG_P9 = 0x9E;
var BME280_REG_DIG_H1 = 0xA1;
var BME280_REG_DIG_H2 = 0xE1;
var BME280_REG_DIG_H3 = 0xE3;
var BME280_REG_DIG_H4 = 0xE4;
var BME280_REG_DIG_H5 = 0xE5;
var BME280_REG_DIG_H6 = 0xE7;
var BME280_REG_CHIP_ID = 0xD0; // const BME280_REG_VERSION = 0xD1;
...
var BME280 = /*#__PURE__*/function () {
  ...
  _createClass(BME280, [{
    key: "read8",
    value: function read8(register) {
      return this.board.i2cReadOnce(this.address, register, 1, this.timeout).then(function (data) {
        return data[0];
      });
    }
    /**
    ...
    key: "readUint16BE",
    value: function readUint16BE(register) {
      return this.board.i2cReadOnce(this.address, register, 2, this.timeout).then(function (data) {
        var dataView = new DataView(new Uint8Array(data).buffer);
        var value = dataView.getUint16(0, false);
        return value;
      });
    }
    /**
    ...
    key: "readUint16LE",
    value: function readUint16LE(register) {
      return this.board.i2cReadOnce(this.address, register, 2, this.timeout).then(function (data) {
        var dataView = new DataView(new Uint8Array(data).buffer);
        var value = dataView.getUint16(0, true);
        return value;
      });
    }
    /**
    ...
    key: "readInt16LE",
    value: function readInt16LE(register) {
      return this.board.i2cReadOnce(this.address, register, 2, this.timeout).then(function (data) {
        var dataView = new DataView(new Uint8Array(data).buffer);
    ...
    key: "read24",
    value: function read24(register) {
      return this.board.i2cReadOnce(this.address, register, 3, this.timeout).then(function (data) {
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.read8(BME280_REG_CHIP_ID);

              case 2:
                chipID = _context.sent;
                ...
                return _context.abrupt("return", Promise.reject("I2C 0x".concat(BME280_ADDRESS.toString(16), " (chip ID 0x").concat(chipID.toString(16), ") \n              is not a BME280 or BMP280")));

              case 5:
                _context.next = 7;
                return this.readUint16LE(BME280_REG_DIG_T1, true);

              case 7:
                this.dig_T1 = _context.sent;
                _context.next = 10;
                return this.readInt16LE(BME280_REG_DIG_T2, true);

              case 10:
                this.dig_T2 = _context.sent;
                _context.next = 13;
                return this.readInt16LE(BME280_REG_DIG_T3, true);

              case 13:
                this.dig_T3 = _context.sent;
                _context.next = 16;
                return this.readUint16LE(BME280_REG_DIG_P1, true);

              case 16:
                this.dig_P1 = _context.sent;
                _context.next = 19;
                return this.readInt16LE(BME280_REG_DIG_P2, true);

              case 19:
                this.dig_P2 = _context.sent;
                _context.next = 22;
                return this.readInt16LE(BME280_REG_DIG_P3, true);

              case 22:
                this.dig_P3 = _context.sent;
                _context.next = 25;
                return this.readInt16LE(BME280_REG_DIG_P4, true);

              case 25:
                this.dig_P4 = _context.sent;
                _context.next = 28;
                return this.readInt16LE(BME280_REG_DIG_P5, true);

              case 28:
                this.dig_P5 = _context.sent;
                _context.next = 31;
                return this.readInt16LE(BME280_REG_DIG_P6, true);

              case 31:
                this.dig_P6 = _context.sent;
                _context.next = 34;
                return this.readInt16LE(BME280_REG_DIG_P7, true);

              case 34:
                this.dig_P7 = _context.sent;
                _context.next = 37;
                return this.readInt16LE(BME280_REG_DIG_P8, true);

              case 37:
                this.dig_P8 = _context.sent;
                _context.next = 40;
                return this.readInt16LE(BME280_REG_DIG_P9, true);

              case 40:
                this.dig_P9 = _context.sent;
                _context.next = 43;
                return this.read8(BME280_REG_DIG_H1);

              case 43:
                this.dig_H1 = _context.sent;
                _context.next = 46;
                return this.readUint16LE(BME280_REG_DIG_H2, true);

              case 46:
                this.dig_H2 = _context.sent;
                _context.next = 49;
                return this.read8(BME280_REG_DIG_H3);

              case 49:
                this.dig_H3 = _context.sent;
                _context.next = 52;
                return this.read8(BME280_REG_DIG_H4);

              case 52:
                _context.t0 = _context.sent;
                _context.t1 = _context.t0 << 4;
                _context.next = 56;
                return this.read8(BME280_REG_DIG_H4 + 1);

              case 56:
                _context.t2 = _context.sent;
                _context.t3 = 0x0F & _context.t2;
                this.dig_H4 = _context.t1 | _context.t3;
                _context.next = 61;
                return this.read8(BME280_REG_DIG_H5 + 1);

              case 61:
                _context.t4 = _context.sent;
                _context.t5 = _context.t4 << 4;
                _context.next = 65;
                return this.read8(BME280_REG_DIG_H5);

              case 65:
                _context.t6 = _context.sent;
                _context.t7 = _context.t6 >> 4;
                _context.t8 = 0x0F & _context.t7;
                this.dig_H5 = _context.t5 | _context.t8;
                _context.next = 71;
                return this.read8(BME280_REG_DIG_H6);
    ...
    key: "readTemperature",
    value: function () {
      var _readTemperature = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
        var adc, var1, var2, var3, temp;
        return regenerator.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
      ...
      function readTemperature() {
        return _readTemperature.apply(this, arguments);
      }
    ...
    key: "readPressure",
    value: function () {
      var _readPressure = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
        var adc, var1, var2, var3, var4, P;
        return regenerator.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
              ...
              case 2:
                _context3.next = 4;
                return this.read24(BME280_REG_PRESSUREDATA);
              ...
              case 7:
                adc >>= 4;
                var1 = Long.fromValue(this.tFine).subtract(128000);
                var2 = var1.multiply(var1).multiply(this.dig_P6);
                var2 = var2.add(var1.multiply(this.dig_P5).multiply(131072));
                var2 = var2.add(Long.fromValue(this.dig_P4).multiply(34359738368));
                var1 = var1.multiply(var1).multiply(this.dig_P3).divide(256).add(var1.multiply(this.dig_P2).multiply(4096));
                var3 = Long.fromValue(1).multiply(140737488355328);
                var1 = var3.add(var1).multiply(this.dig_P1).divide(8589934592);
              ...
              case 17:
                var4 = Long.fromValue(1048576).subtract(adc);
                var4 = var4.multiply(2147483648).subtract(var2).multiply(3125).divide(var1);
                var1 = Long.fromValue(this.dig_P9).multiply(var4.divide(8192)).multiply(var4.divide(8192)).divide(33554432);
                var2 = Long.fromValue(this.dig_P8).multiply(var4).divide(524288);
                var4 = var4.add(var1).add(var2).divide(256).add(Long.fromValue(this.dig_P7).multiply(16));
                P = var4.divide(256.0);
                return _context3.abrupt("return", P.toNumber());
      ...
      function readPressure() {
        return _readPressure.apply(this, arguments);
      }
    ...
    key: "readHumidity",
    value: function () {
      var _readHumidity = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
        var adc, var1, var2, var3, var4, var5, H;
        return regenerator.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
              ...
              case 2:
                _context4.next = 4;
                return this.readUint16BE(BME280_REG_HUMIDITYDATA);
              ...
              case 7:
                var1 = this.tFine - 76800;
                var2 = adc * 16384;
                var3 = this.dig_H4 * 1048576;
                var4 = this.dig_H5 * var1;
                ...
                H = var5 / 4096;
                return _context4.abrupt("return", H / 1024.0);
      ...
      function readHumidity() {
        return _readHumidity.apply(this, arguments);
      }
...
for (var _i = 0, _arr = ['Boolean', 'Number', 'String', 'Function', 'Array', 'Date', 'RegExp', 'Undefined', 'Null']; _i < _arr.length; _i++) {
  var name = _arr[_i];
  classToType["[object ".concat(name, "]")] = name.toLowerCase();
}
...
var unpack = (function (args) {
  var keyOrder = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
var rnd2 = function rnd2(a) {
  return Math.round(a * 100) / 100;
};

var rnd3 = function rnd3(a) {
  return Math.round(a * 100) / 100;
};
var TWOPI = PI$2 * 2;
var PITHIRD = PI$2 / 3;
...
function reverse3(arr) {
  return [].concat(_toConsumableArray(arr.slice(0, 3).reverse()), _toConsumableArray(arr.slice(3)));
}
...
var Color = /*#__PURE__*/function () {
  function Color() {
    ...
    if (!mode) {
      ...
      var _iterator = _createForOfIteratorHelper$1(input.autodetect),
          _step;
...
var hex2rgb = function hex2rgb(hex) {
  ...
  throw new Error("unknown hex color: ".concat(hex));
};
...
var rgb2hex = function rgb2hex() {
  ...
  var _unpack = unpack(args, 'rgba'),
      _unpack2 = _slicedToArray(_unpack, 4),
      r = _unpack2[0],
      g = _unpack2[1],
      b = _unpack2[2],
      a = _unpack2[3];
  ...
  var hxa = '0' + round$5(a * 255).toString(16);
...
Color.prototype.name = function () {
  ...
  for (var _i = 0, _Object$keys = Object.keys(w3cx11); _i < _Object$keys.length; _i++) {
...
input.autodetect.push({
  ...
  test: function test(h) {
    if (!(arguments.length <= 1 ? 0 : arguments.length - 1) && type(h) === 'string' && w3cx11[h.toLowerCase()]) {
      return 'named';
    }
  }
});
...
var ILLUMINANTS = new Map([// ASTM E308-01
...
var xyz2rgb = function xyz2rgb(x, y, z) {
  var MtxAdaptMa = labConstants.MtxAdaptMa,
      MtxAdaptMaI = labConstants.MtxAdaptMaI,
      MtxXYZ2RGB = labConstants.MtxXYZ2RGB,
      RefWhiteRGB = labConstants.RefWhiteRGB,
      Xn = labConstants.Xn,
      Yn = labConstants.Yn,
      Zn = labConstants.Zn;
...
function _toArray(arr) {
  return _arrayWithHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray$5(arr) || _nonIterableRest();
}
...
var rgb2lab = function rgb2lab() {
  ...
  var _unpack = unpack(args, 'rgb'),
      _unpack2 = _toArray(_unpack),
      r = _unpack2[0],
      g = _unpack2[1],
      b = _unpack2[2],
      rest = _unpack2.slice(3);
  ...
  return [L, a, b_].concat(_toConsumableArray(rest.length > 0 && rest[0] < 1 ? [rest[0]] : []));
};
...
var rgb2xyz = function rgb2xyz(r, g, b) {
  ...
  var MtxRGB2XYZ = labConstants.MtxRGB2XYZ,
      MtxAdaptMa = labConstants.MtxAdaptMa,
      MtxAdaptMaI = labConstants.MtxAdaptMaI,
      Xn = labConstants.Xn,
      Yn = labConstants.Yn,
      Zn = labConstants.Zn,
...
var lab$1 = function lab() {
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }

  return _construct(Color, args.concat(['lab']));
};
...
Color.prototype.get = function (mc) {
  var _mc$split = mc.split('.'),
      _mc$split2 = _slicedToArray(_mc$split, 2),
      mode = _mc$split2[0],
      channel = _mc$split2[1];
  ...
  if (channel) {
    ...
    if (i > -1) return src[i];
    throw new Error("unknown channel ".concat(channel, " in mode ").concat(mode));
  } else {
    return src;
  }
};
...
Color.prototype.luminance = function (lum) {
  ...
  if (lum !== undefined && type(lum) === 'number') {
    ...
    var rgb = (cur_lum > lum ? test(new Color([0, 0, 0]), this) : test(this, new Color([255, 255, 255]))).rgb();
    return new Color([].concat(_toConsumableArray(rgb), [this._rgb[3]]));
  }

  return rgb2luminance.apply(void 0, _toConsumableArray(this._rgb.slice(0, 3)));
};
...
Color.prototype.mix = Color.prototype.interpolate = function (col2) {
...
Color.prototype.premultiply = function () {
  var mutate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  var rgb = this._rgb;
  var a = rgb[3];
...
var lch2lab = function lch2lab() {
  ...
  */
  var _unpack = unpack(args, 'lch'),
      _unpack2 = _slicedToArray(_unpack, 3),
      l = _unpack2[0],
      c = _unpack2[1],
      h = _unpack2[2];
...
var lch2rgb = function lch2rgb() {
  ...
  var _lch2lab = lch2lab(l, c, h),
      _lch2lab2 = _slicedToArray(_lch2lab, 3),
      L = _lch2lab2[0],
      a = _lch2lab2[1],
      b_ = _lch2lab2[2];

  var _lab2rgb = lab2rgb(L, a, b_),
      _lab2rgb2 = _slicedToArray(_lab2rgb, 3),
      r = _lab2rgb2[0],
      g = _lab2rgb2[1],
      b = _lab2rgb2[2];
...
var hcl2rgb = function hcl2rgb() {
  ...
  return lch2rgb.apply(void 0, _toConsumableArray(hcl));
};
...
var rgb2lch = function rgb2lch() {
  ...
  var _rgb2lab = rgb2lab(r, g, b),
      _rgb2lab2 = _slicedToArray(_rgb2lab, 3),
      l = _rgb2lab2[0],
      a = _rgb2lab2[1],
      b_ = _rgb2lab2[2];

  var _lab2lch = lab2lch(l, a, b_),
      _lab2lch2 = _slicedToArray(_lab2lch, 3),
      L = _lab2lch2[0],
      c = _lab2lch2[1],
      h = _lab2lch2[2];

  return [L, c, h].concat(_toConsumableArray(rest.length > 0 && rest[0] < 1 ? [rest[0]] : []));
};
...
var lch$1 = function lch() {
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }

  return _construct(Color, args.concat(['lch']));
};

var hcl = function hcl() {
  for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
    args[_key2] = arguments[_key2];
  }

  return _construct(Color, args.concat(['hcl']));
};
...
Color.prototype.set = function (mc, value) {
...
Color.prototype.tint = function () {
  var f = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0.5;
...
var rgb$1 = function rgb(col1, col2, f) {
  var xyz0 = col1._rgb;
  var xyz1 = col2._rgb;
...
var lrgb = function lrgb(col1, col2, f) {
  var _col1$_rgb = _slicedToArray(col1._rgb, 3),
      x1 = _col1$_rgb[0],
      y1 = _col1$_rgb[1],
      z1 = _col1$_rgb[2];

  var _col2$_rgb = _slicedToArray(col2._rgb, 3),
      x2 = _col2$_rgb[0],
      y2 = _col2$_rgb[1],
      z2 = _col2$_rgb[2];
...
var interpolate_hsx = (function (col1, col2, f, m) {
  var xyz0, xyz1;
  ...
  if (m.substr(0, 1) === 'h' || m === 'oklch') {
    ...
    var _xyz2 = _slicedToArray(_xyz, 3);
    ...
    var _xyz4 = _slicedToArray(_xyz3, 3);
...
var num$1 = function num() {
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }

  return _construct(Color, args.concat(['num']));
};
...
input.autodetect.push({
  p: 5,
  test: function test() {
    if (arguments.length === 1 && type(arguments.length <= 0 ? undefined : arguments[0]) === 'number' && (arguments.length <= 0 ? undefined : arguments[0]) >= 0 && (arguments.length <= 0 ? undefined : arguments[0]) <= 0xffffff) {
      return 'num';
    }
  }
});
...
var hcg$1 = function hcg() {
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }

  return _construct(Color, args.concat(['hcg']));
};
...
var hsi$1 = function hsi() {
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }

  return _construct(Color, args.concat(['hsi']));
};
...
var rgb2hsl$1 = function rgb2hsl() {
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }
...
var hsl$1 = function hsl() {
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }

  return _construct(Color, args.concat(['hsl']));
};
...
var hsv$1 = function hsv() {
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }

  return _construct(Color, args.concat(['hsv']));
};
...
var oklab2rgb = function oklab2rgb() {
  ...
  var _OKLab_to_XYZ = OKLab_to_XYZ([L, a, b]),
      _OKLab_to_XYZ2 = _slicedToArray(_OKLab_to_XYZ, 3),
      X = _OKLab_to_XYZ2[0],
      Y = _OKLab_to_XYZ2[1],
      Z = _OKLab_to_XYZ2[2];
  ...
  return [r, g, b_].concat(_toConsumableArray(rest.length > 0 && rest[0] < 1 ? [rest[0]] : []));
...
function OKLab_to_XYZ(OKLab) {
  ...
  return multiplyMatrices(LMStoXYZ, LMSnl.map(function (c) {
    return Math.pow(c, 3);
  }));
}
...
var rgb2oklab = function rgb2oklab() {
  ...
  return [].concat(_toConsumableArray(oklab), _toConsumableArray(rest.length > 0 && rest[0] < 1 ? [rest[0]] : []));
}; // from https://www.w3.org/TR/css-color-4/#color-conversion-code
...
function XYZ_to_OKLab(XYZ) {
  ...
  var LMS = multiplyMatrices(XYZtoLMS, XYZ); // JavaScript Math.cbrt returns a sign-matched cube root
  // beware if porting to other languages
  // especially if tempted to use a general power function

  return multiplyMatrices(LMStoOKLab, LMS.map(function (c) {
    return Math.cbrt(c);
...
var oklab$1 = function oklab() {
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }

  return _construct(Color, args.concat(['oklab']));
};
...
var oklch$1 = function oklch(col1, col2, f) {
...
var pow$4 = Math.pow,
    ...
    sin$2 = Math.sin,
    atan2$1 = Math.atan2;
var average = (function (colors) {
  var mode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'lrgb';
  var weights = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  var l = colors.length;
  ...
  colors.forEach(function (c, ci) {
    ...
    for (var _i = 0; _i < xyz.length; _i++) {
      if (!isNaN(xyz2[_i])) {
        ...
        if (mode.charAt(_i) === 'h') {
          var _A = xyz2[_i] / 180 * PI$1;

          dx += cos$2(_A) * weights[ci + 1];
          dy += sin$2(_A) * weights[ci + 1];
        } else {
  ...
  for (var _i2 = 0; _i2 < xyz.length; _i2++) {
    if (mode.charAt(_i2) === 'h') {
      var _A2 = atan2$1(dy / cnt[_i2], dx / cnt[_i2]) / PI$1 * 180;
...
var bezier = function bezier(colors) {
  ...
  if (colors.length === 2) {
    ...
    var _colors$map2 = _slicedToArray(_colors$map, 2);
    ...
    var _colors$map4 = _slicedToArray(_colors$map3, 3);
    ...
    var _colors$map5 = colors.map(function (c) {
      return c.lab();
    });

    var _colors$map6 = _slicedToArray(_colors$map5, 4);
...
Color.prototype.rgb = function () {
  var rnd = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
...
var rgb = function rgb() {
  ...
  return _construct(Color, args.concat(['rgb']));
};
...
var pow$2 = Math.pow,
    ...
    cos$1 = Math.cos;
function cubehelix () {
  var start = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 300;
  var rotations = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : -1.5;
  var hue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
  var gamma = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
  var lightness = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : [0, 1];
  var dh = 0,
      dl;
...
function limits(data) {
  var mode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'equal';
  var num = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 7;
  ...
  if (mode.substr(0, 1) === 'e') {
    ...
    for (var _i = 1; _i < num; _i++) {
      limits.push(pow$1(10, min_log + _i / num * (max_log - min_log)));
    }
    ...
    while (repeat) {
      ...
      for (var _i4 = 0; _i4 < n; _i4++) {
        ...
        for (var _j = 0; _j < num; _j++) {
          var dist = abs$1(centroids[_j] - value);
...
var B_exp = 1.414;
var contrastAPCA = (function (text, bg) {
  // parse input colors
  text = new Color(text);
  bg = new Color(bg); // if text color has alpha, blend against background

  if (text.alpha() < 1) {
    text = mix(bg, text, text.alpha(), 'rgb');
  }

  var l_text = lum.apply(void 0, _toConsumableArray(text.rgb()));
  var l_bg = lum.apply(void 0, _toConsumableArray(bg.rgb())); // soft clamp black levels

  var Y_text = l_text >= B_threshold ? l_text : l_text + Math.pow(B_threshold - l_text, B_exp);
  var Y_bg = l_bg >= B_threshold ? l_bg : l_bg + Math.pow(B_threshold - l_bg, B_exp); // normal polarity (dark text on light background)
...
var sqrt = Math.sqrt,
    ...
    PI = Math.PI;
function deltaE (a, b) {
  var Kl = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
  var Kc = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
  var Kh = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
  ...
  var _Array$from3 = Array.from(b.lab()),
...
function distance (a, b) {
  var mode = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'lab';
  // Delta E (CIE 1976)
...
var cmyk = function cmyk() {
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }

  return _construct(Color, args.concat(['cmyk']));
};
...
var hsl2css = function hsl2css() {
  ...
  return "".concat(mode.substr(0, 3), "(").concat(hsla.join(' '), ")");
};
...
var rgb2oklch = function rgb2oklch() {
  ...
  var _rgb2oklab = rgb2oklab(r, g, b),
      _rgb2oklab2 = _slicedToArray(_rgb2oklab, 3),
      l = _rgb2oklab2[0],
      a = _rgb2oklab2[1],
      b_ = _rgb2oklab2[2];
...
var rgb2css = function rgb2css() {
  ...
  if (mode.substr(0, 3) === 'lch') {
    // change to D50 lab whitepoint since this is what W3C is using for CSS Lab colors
    var _prevWhitePoint = getLabWhitePoint();

    setLabWhitePoint('d50');

    var _cssColor = lch2css(rgb2lch(rgba), mode);

    setLabWhitePoint(_prevWhitePoint);
    return _cssColor;
  }
...
var oklch2rgb = function oklch2rgb() {
  ...
  var _oklab2rgb = oklab2rgb(L, a, b_),
      _oklab2rgb2 = _slicedToArray(_oklab2rgb, 3),
      r = _oklab2rgb2[0],
      g = _oklab2rgb2[1],
      b = _oklab2rgb2[2];

  return [r, g, b].concat(_toConsumableArray(rest.length > 0 && rest[0] < 1 ? [rest[0]] : []));
};
...
var ALPHA = /\s*(?:\/\s*((?:[01]|[01]?\.\d+)|\d+(?:\.\d+)?%))?/.source; // e.g. rgb(250 20 0), rgb(100% 50% 20%), rgb(100% 50% 20% / 0.5)
...
var roundRGB = function roundRGB(rgb) {
  return rgb.map(function (v, i) {
    return i <= 2 ? limit(round$1(v), 0, 255) : v;
  });
};

var percentToAbsolute = function percentToAbsolute(pct) {
...
var css2rgb = function css2rgb(css) {
  ...
  if (input.format.named) {
    try {
      return input.format.named(css); // eslint-disable-next-line
    } catch (e) {}
  ...
  if ((m = css.match(RE_HSL)) || (m = css.match(RE_HSL_LEGACY))) {
    ...
    var _rgb2 = roundRGB(hsl2rgb(hsl));
  ...
  if (m = css.match(RE_HSLA_LEGACY)) {
    ...
    var _rgb3 = hsl2rgb(_hsl);

    for (var _i2 = 0; _i2 < 3; _i2++) {
      _rgb3[_i2] = round$1(_rgb3[_i2]);
    }

    _rgb3[3] = +m[4]; // default alpha = 1
  ...
  if (m = css.match(RE_LAB)) {
    ...
    lab[2] = percentToAbsolute(noneToValue(lab[2], 0), -125, 125, true); // convert to D50 Lab whitepoint

    var wp = getLabWhitePoint();
    setLabWhitePoint('d50');

    var _rgb4 = roundRGB(lab2rgb(lab)); // convert back to original Lab whitepoint
  ...
  if (m = css.match(RE_LCH)) {
    ...
    var _wp = getLabWhitePoint();

    setLabWhitePoint('d50');

    var _rgb5 = roundRGB(lch2rgb(lch)); // convert back to original Lab whitepoint


    setLabWhitePoint(_wp);
  ...
  if (m = css.match(RE_OKLAB)) {
    ...
    var _rgb6 = roundRGB(oklab2rgb(oklab));
  ...
  if (m = css.match(RE_OKLCH)) {
    ...
    var _rgb7 = roundRGB(oklch2rgb(oklch));
...
var css = function css() {
  ...
  return _construct(Color, args.concat(['css']));
};
...
input.autodetect.push({
  p: 5,
  test: function test(h) {
    if (!(arguments.length <= 1 ? 0 : arguments.length - 1) && type(h) === 'string' && css2rgb.test(h)) {
      return 'css';
    }
  }
});
...
var gl = function gl() {
  ...
  return _construct(Color, args.concat(['gl']));
};
...
var hex = function hex() {
  ...
  return _construct(Color, args.concat(['hex']));
};
...
input.autodetect.push({
  p: 4,
  test: function test(h) {
    if (!(arguments.length <= 1 ? 0 : arguments.length - 1) && type(h) === 'string' && [3, 4, 5, 6, 7, 8, 9].indexOf(h.length) >= 0) {
      return 'hex';
    }
  }
});
...
var temp = function temp() {
  ...
  return _construct(Color, args.concat(['temp']));
};
...
var oklch = function oklch() {
  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }

  return _construct(Color, args.concat(['oklch']));
};
...
var integer64From = function integer64From(valueInput, unsigned) {
...
var readAsNumericArray = function readAsNumericArray(stringExp) {
  ...
  if (stringExp.includes(',')) {
    var _iterator = _createForOfIteratorHelper(stringExp.split(',')),
        _step;

    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var numberString = _step.value;
        var trimmedNumberString = numberString.trim();
    ...
    var _iterator2 = _createForOfIteratorHelper(stringExp.split(/\s+/)),
        _step2;
...
var setupTranslations = function setupTranslations() {
  var localeSetup = formatMessage.setup(); // biome-ignore lint/complexity/useOptionalChain: scratchのbuildはOptionalChainが使えない
...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  function ExtensionBlocks(runtime) {
    ...
    for (var _i = 0, _arr = [6, 9, 10, 11, 14, 15, 16, 17]; _i < _arr.length; _i++) {
      var pin = _arr[_i];
      this.pins[pin] = {};
    ...
    this.runtime.on('PROJECT_STOP_ALL', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _this.resetPinMode();

            case 2:
              _context.next = 4;
              return _this.neoPixelClearAll();
  ...
  _createClass(ExtensionBlocks, [{
    key: "resetPinMode",
    value: function () {
      var _resetPinMode = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
        var _i2, _arr2, pin;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _context2.next = 8;
                return this.board.pwmWrite(pin, 0);

              case 8:
                _context2.next = 10;
                return this.board.pinMode(pin, this.board.MODES.INPUT);
              ...
              case 13:
                ...
                _context2.next = 16;
                return this.board.pwmWrite(3, 0);
      ...
      function resetPinMode() {
        return _resetPinMode.apply(this, arguments);
      }
    ...
    value: function neoPixelClearAll() {
      ...
      return this.neoPixelOperationWithLock({}, {}, function () {
        return _this2.board.neoPixelClearAll();
      });
    }
    /**
    ...
    value: function inputBiasSet(args) {
      if (!this.isConnected()) return;
      var pin = Number.parseInt(args.PIN, 10);
    ...
    value: function digitalLevelSet(args) {
      if (!this.isConnected()) return;
      var pin = Number.parseInt(args.CONNECTOR, 10);
    ...
    value: function measureCurrent() {
      ...
      if (typeof level !== 'number') return '';
      var current = level > METER_MIN_LEVEL ? level * METER_CURRENT_COEFF : 0; // 分解能はレベル0.1刻み×0.02=0.002Aなので小数第3位まで残す
    ...
    key: "analogLevelSet",
    value: function () {
      var _analogLevelSet = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(args) {
        var pin, percent, value, minInterval, lastTimestamp, interval;
        return regenerator.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
              ...
              case 6:
                percent = Math.min(Math.max(cast.toNumber(args.LEVEL), 0), 100);
                value = Math.round(this.board.RESOLUTION.PWM * (percent / 100));
                minInterval = cast.toNumber(args.MIN_INTERVAL); // 前回の同一PINに対する書き込み時刻保存用マップがなければ初期化
                ...
                lastTimestamp = this.analogLevelSetLastTimestampMap.get(pin);
                ...
                interval = Date.now() - lastTimestamp;
                ...
                _context3.next = 17;
                return new Promise(function (resolve) {
                  return setTimeout(resolve, minInterval - interval);
                });
              ...
              case 17:
                ...
                return _context3.abrupt("return", this.board.pwmWrite(pin, value));
      ...
      function analogLevelSet(_x) {
        return _analogLevelSet.apply(this, arguments);
      }

      return analogLevelSet;
    }()
    /**
    ...
    value: function i2cReadOnce(args) {
      ...
      var address = Number(args.ADDRESS);
      var register = Number(args.REGISTER);
      var length = Number.parseInt(cast.toNumber(args.LENGTH), 10);
    ...
    value: function oneWireWriteAndRead(args) {
      ...
      var pin = Number.parseInt(args.CONNECTOR, 10);
      var data = readAsNumericArray(args.DATA);
      var readLength = Number.parseInt(cast.toNumber(args.LENGTH), 10);
    ...
    key: "neoPixelConfigStrip",
    value: function neoPixelConfigStrip(args, util) {
      var _this4 = this;

      return this.neoPixelOperationWithLock(args, util, function (pin) {
        if (pin == null) return;
        var length = Math.max(0, Math.min(60, cast.toNumber(Number.parseInt(args.LENGTH, 10))));
        return _this4.board.neoPixelConfigStrip(pin, length).then(function () {});
      });
    }
    /**
     * Update color of LEDs on the all of NeoPixel modules.
    ...
    key: "neoPixelShow",
    value: function neoPixelShow(args, util) {
      var _this5 = this;

      return this.neoPixelOperationWithLock(args, util, function () {
        return _this5.board.neoPixelShow().then(function () {});
      });
    }
    /**
    ...
    key: "neoPixelSetColor",
    value: function neoPixelSetColor(args, util) {
      var _this6 = this;

      return this.neoPixelOperationWithLock(args, util, function (pin) {
        if (pin == null) return;
        var index = cast.toNumber(args.POSITION) - 1;
        var brightness = Math.max(0, Math.min(100, cast.toNumber(args.BRIGHTNESS))) / 100; // -1 は虹色として解釈する

        if (args.COLOR === 'rainbow') {
          var colorFn = function colorFn(_, i, colors) {
            if (i === index) {
          ...
          return _this6.board.neoPixelFillColor(pin, colorFn);
        } // 指定された色をセットする


        var color = parseColor(args.COLOR, brightness);
        return _this6.board.neoPixelSetColor(pin, color, index).then(function () {});
      });
    }
    /**
    ...
    value: function neoPixelFillColor(args, util) {
      ...
      return this.neoPixelOperationWithLock(args, util, function (pin) {
        if (pin == null) return;
        var brightness = cast.toNumber(args.BRIGHTNESS) / 100;
        var colorFn = null;

        if (args.COLOR === 'rainbow') {
          colorFn = function colorFn(_, i, colors) {
            return getRainbowColor(i, colors.length, brightness);
          };
        ...
        return _this7.board.neoPixelFillColor(pin, colorFn).then(function () {});
      });
    }
  }, {
    key: "neoPixelShiftColor",
    value: function neoPixelShiftColor(args, util) {
      var _this8 = this;

      return this.neoPixelOperationWithLock(args, util, function (pin) {
        if (pin == null) return;
        var n = cast.toNumber(args.N);
        var loopMode = cast.toBoolean(args.LOOP_MODE); // 色をシフトする関数で塗りつぶす

        var colorMapFn = function colorMapFn(curColor, i, colors) {
          var length = colors.length;
          var fromIndex = i - n;
          var fromIndexInLoop = (fromIndex % length + length) % length;
          var newColor = loopMode ? colors[fromIndexInLoop] : colors[fromIndex]; // 色が変化していなければスキップ
        ...
        return _this8.board.neoPixelFillColor(pin, colorMapFn).then(function () {});
      });
    }
    /**
    ...
    key: "neoPixelOperationWithLock",
    value: function neoPixelOperationWithLock(args, util, operation) {
      if (!this.isConnected()) return;
      var pin = Number.parseInt(args.CONNECTOR, 10);
    ...
    key: "neoPixelColorMode",
    value: function neoPixelColorMode(args) {
      return args.MODE;
    }
    /**
     * Turn off the all LEDs on the NeoPixel module on the pin.
    ...
    key: "neoPixelClear",
    value: function neoPixelClear(args, util) {
      var _this9 = this;

      return this.neoPixelOperationWithLock(args, util, function (pin) {
        if (pin == null) return;
        return _this9.board.neoPixelClear(pin);
      });
    }
  }, {
    key: "getOpticalDistanceSensor",
    value: function () {
      var _getOpticalDistanceSensor = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
        ...
        return regenerator.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 15:
                return _context4.abrupt("return", this.vl53l0x);
    ...
    value: function measureDistanceWithLight(_args, util) {
      ...
      if (Date.now() - this.opticalDistanceUpdatedTime > this.opticalDistanceUpdateIntervalTime) {
        ...
        measureRequest = measureRequest.then(function () {
          return _this10.getOpticalDistanceSensor();
          ...
          _this10.opticalDistance = distance;
          return distance;
        }).finally(function () {
          _this10.opticalDistanceUpdating = false;
        });
      }
      ...
      .then(function (distance) {
        return _this10.reduceNoiseOfOpticalDistance(distance);
      }).catch(function (reason) {
        console.log("measureDistanceWithLight was rejected by ".concat(reason));
        _this10.opticalDistance = null;
        return '';
      });
    }
    /**
    ...
    value: function measureDistanceWithUltrasonicA(_args, util) {
      ...
      if (Date.now() - this.sonicDistanceAUpdatedTime > this.sonicDistanceAUpdateIntervalTime) {
        ...
        getter = getter.then(function () {
          return _this11.board.getDistanceByUltrasonic(pin);
        }).then(function (value) {
          _this11.sonicDistanceA = value;
          _this11.sonicDistanceAUpdatedTime = Date.now();
          return _this11.sonicDistanceA;
        }).finally(function () {
          _this11.sonicDistanceAUpdating = false;
        });
      }
    ...
    value: function measureDistanceWithUltrasonicB(_args, util) {
      ...
      if (Date.now() - this.sonicDistanceBUpdatedTime > this.sonicDistanceBUpdateIntervalTime) {
        ...
        var pin = 6;
        getter = getter.then(function () {
          return _this12.board.getDistanceByUltrasonic(pin);
        }).then(function (value) {
          _this12.sonicDistanceB = value;
          _this12.sonicDistanceBUpdatedTime = Date.now();
          return _this12.sonicDistanceB;
        }).finally(function () {
          _this12.sonicDistanceBUpdating = false;
        });
      }
    ...
    value: function () {
      var _getAccelerometer = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5() {
        ...
        return regenerator.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 4:
                isKXTJ3Connected = _context5.sent;
              ...
              case 11:
                isADXL345Connected = _context5.sent;
              ...
              case 20:
                return _context5.abrupt("return", this.accelerometer);
    ...
    key: "getAcceleration",
    value: function () {
      var _getAcceleration = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6() {
        var sensor;
        return regenerator.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 3:
                sensor = _context6.sent;
                _context6.next = 6;
                return sensor.getAcceleration();

              case 6:
                this.acceleration = _context6.sent;
                this.accelerationUpdatedTime = Date.now();
                return _context6.abrupt("return", this.acceleration);

              case 11:
                _context6.prev = 11;
                _context6.t0 = _context6["catch"](0);
                console.log("getAcceleration() was rejected by ".concat(_context6.t0));
                this.acceleration = null;
    ...
    value: function updateAcceleration(util) {
      ...
      if (Date.now() - this.accelerationUpdatedTime > this.accelerationUpdateIntervalTime) {
        ...
        getRequest = getRequest.then(function () {
          return _this13.getAcceleration();
        }).finally(function () {
          _this13.accelerationUpdating = false;
        });
      }
    ...
    key: "getEnvSensor",
    value: function () {
      var _getEnvSensor = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee7() {
        var newSensor;
        return regenerator.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 5:
                return _context7.abrupt("return", this.envSensor);
    ...
    value: function () {
      var _getEvnTemperature = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee8(_args, util) {
        var _this14 = this;
            ...
            switch (_context8.prev = _context8.next) {
              ...
              case 7:
                ...
                getter = getter.then(function () {
                  ...
                  return _this14.envSensor.readTemperature();
                }).then(function (envTemperature) {
                  _this14.envTemperature = envTemperature;
                  _this14.envTemperatureUpdatedTime = Date.now();
                  return envTemperature;
                }).finally(function () {
                  _this14.envTemperatureUpdating = false;
                });

              case 9:
                return _context8.abrupt("return", getter.then(function (envTemperature) {
                  return Math.round(envTemperature * 100) / 100;
                }).catch(function (reason) {
                  console.log("getting environment temperature was rejected by ".concat(reason));
                  _this14.envTemperature = null;
      ...
      function getEvnTemperature(_x2, _x3) {
    ...
    key: "getEvnPressure",
    value: function () {
      var _getEvnPressure = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee9(_args, util) {
        var _this15 = this;
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 5:
                ...
                getter = getter.then(function () {
                  return _this15.getEnvSensor();
                }).then(function () {
                  return _this15.envSensor.readPressure();
                }).then(function (envPressure) {
                  _this15.envPressure = envPressure;
                  _this15.envPressureUpdatedTime = Date.now();
                  return envPressure;
                }).finally(function () {
                  _this15.envPressureUpdating = false;
                });

              case 7:
                return _context9.abrupt("return", getter.then(function (envPressure) {
                  return Math.round(envPressure * 100) / 10000;
                }).catch(function (reason) {
                  console.log("getting environment pressure was rejected by ".concat(reason));
                  _this15.envPressure = null;
                  _this15.envSensor = null;
                  return '';
                }));
      ...
      function getEvnPressure(_x4, _x5) {
    ...
    key: "getEnvHumidity",
    value: function () {
      var _getEnvHumidity = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10(_args, util) {
        var _this16 = this;
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 5:
                ...
                getter = getter.then(function () {
                  return _this16.getEnvSensor();
                }).then(function () {
                  return _this16.envSensor.readHumidity();
                }).then(function (envHumidity) {
                  _this16.envHumidity = envHumidity;
                  _this16.envHumidityUpdatedTime = Date.now();
                  return envHumidity;
                }).finally(function () {
                  _this16.envHumidityUpdating = false;
                });

              case 7:
                return _context10.abrupt("return", getter.then(function (envHumidity) {
                  return Math.round(envHumidity * 100) / 100;
                }).catch(function (reason) {
                  console.log("getting environment humidity was rejected by ".concat(reason));
                  _this16.envHumidity = null;
                  _this16.envSensor = null;
                  return '';
                }));
      ...
      function getEnvHumidity(_x6, _x7) {
    ...
    value: function () {
      var _getBrightnessSensor = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee11() {
        var newSensor;
        return regenerator.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 5:
                return _context11.abrupt("return", this.brightnessSensor);
    ...
    key: "getBrightness",
    value: function () {
      var _getBrightness = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12(_args, util) {
        var _this17 = this;
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 7:
                ...
                getter = getter.then(function () {
                  return _this17.getBrightnessSensor();
                }).then(function () {
                  return _this17.brightnessSensor.getBrightness();
                }).then(function (brightness) {
                  _this17.brightness = brightness;
                  _this17.brightnessUpdatedTime = Date.now();
                  return brightness;
                }).finally(function () {
                  _this17.brightnessUpdating = false;
                });

              case 9:
                return _context12.abrupt("return", getter.then(function (brightness) {
                ...
                .catch(function (reason) {
                  ...
                  _this17.brightness = null;
                  _this17.brightnessSensor = null;
                  return '';
                }));
      ...
      function getBrightness(_x8, _x9) {
        return _getBrightness.apply(this, arguments);
      }
    ...
    value: function getTemperatureDS18B20(pin) {
      ...
      return this.board.sendOneWireReset(pin).then(function () {
        return _this18.board.oneWireWrite(pin, 0x44);
      }).then(function () {
        return _this18.board.sendOneWireReset(pin);
      }).then(function () {
        return _this18.board.oneWireWriteAndRead(pin, 0xBE, 9);
      }).then(function (readData) {
        var buffer = new Uint8Array(readData).buffer;
        var dataView = new DataView(buffer);
        var rawTemp = dataView.getInt16(0, true);
    ...
    value: function getWaterTemperatureA(_args, util) {
      ...
      if (Date.now() - this.waterTempAUpdatedTime > this.waterTempAUpdateIntervalTime) {
        ...
        getter = getter.then(function () {
          return _this19.getWaterTemp(10, util);
        }) // Digital A1: 10
        .then(function (waterTempA) {
          _this19.waterTempA = waterTempA;
          _this19.waterTempAUpdatedTime = Date.now();
          return waterTempA;
        }).finally(function () {
          _this19.waterTempAUpdating = false;
        });
      }

      return getter.catch(function (reason) {
        console.log("getting water temperature A was rejected by ".concat(reason));
        _this19.waterTempA = null;
        return '';
      });
    }
    /**
    ...
    value: function getWaterTemperatureB(_args, util) {
      ...
      if (Date.now() - this.waterTempBUpdatedTime > this.waterTempBUpdateIntervalTime) {
        ...
        getter = getter.then(function () {
          return _this20.getWaterTemp(6, util);
        }) // Digital B1: 6;
        .then(function (waterTempB) {
          _this20.waterTempB = waterTempB;
          _this20.waterTempBUpdatedTime = Date.now();
          return waterTempB;
        }).finally(function () {
          _this20.waterTempBUpdating = false;
        });
      }

      return getter.catch(function (reason) {
        console.log("getting water temperature A was rejected by ".concat(reason));
        _this20.waterTempB = null;
        return '';
      });
    }
    /**
          ...
          if (typeof this.prevAccAbsolute !== 'undefined' && this.prevAccAbsolute !== null) {
            ...
            setTimeout(function () {
              updater.then(function (currentAcc) {
                if (currentAcc === '') {
                  _this21.shakeEventUpdating = false;
                  return;
                }

                _this21.shaken = currentAcc - _this21.prevAccAbsolute > _this21.shakeEventThreshold;
                _this21.prevAccAbsolute = currentAcc;
                setTimeout(function () {
                  _this21.shakeEventUpdating = false;
                }, _this21.runtime.currentStepTime);
              }).catch(function (reason) {
                _this21.shakeEventUpdating = false;
    ...
    value: function spliceNumbers(args) {
      ...
      var index = cast.toNumber(args.INDEX);
      index = Math.floor(index);
      var deleteCount = cast.toNumber(args.DELETE);
    ...
    key: "openShareGroupIDDialog",
    value: function openShareGroupIDDialog() {
      var _this22 = this;
      ...
      return new Promise(function (resolve) {
        ...
        var canceled = function canceled() {
          _this22.dataSharingWasCanceled = true;
          resolveID('');
        };
        ...
        _this22.shareGroupIDDialogOpened = false;
      });
    }
    /**
    ...
    key: "getShareGroupID",
    value: function getShareGroupID() {
      var getter;
    ...
    key: "reportShareGroupID",
    value: function reportShareGroupID() {
      if (typeof this.shareGroupID === 'undefined' || this.shareGroupID === null) {
        return '';
      }
    ...
    key: "openSocketForShareServer",
    value: function openSocketForShareServer() {
      var _this23 = this;

      var url = this.shareServerURL + encodeURIComponent(this.shareGroupID);
      var connecting = new Promise(function (resolve) {
        ...
        server.onmessage = function (event) {
          ...
          _this23.sharedData[received.key] = {
        ...
        server.onclose = function () {
          console.info("ShareServer closed ".concat(url));
        };

        server.onopen = function () {
          console.info("ShareServer opened ".concat(url));
          _this23.shareServer = server;
          _this23.shareServerBackoffAttempt = 0;
          resolve(server);
        };
      });
      return Promise.race([connecting, new Promise(function (resolve) {
        setTimeout(function () {
          resolve(null);
        }, _this23.shareServerConnectWaitingTime);
      })]);
    }
    /**
    ...
    key: "isShareServerConnected",
    value: function isShareServerConnected() {
    ...
    value: function getShareServer() {
      ...
      if (this.shareServer) {
        if (!this.isShareServerConnected()) {
          ...
          var jitter = Math.min(this.shareServerBackoffCap, this.shareServerBackoffBase * Math.pow(2, this.shareServerBackoffAttempt));
          ...
          return new Promise(function (resolve) {
            ...
            return _this24.openSocketForShareServer();
          }).finally(function () {
      ...
      return this.openShareGroupIDDialog().then(function (groupID) {
        if (typeof groupID === 'undefined' || groupID === null) {
          // Prevent to connect when the groupID was invalid.
          return null;
        }

        _this24.shareGroupID = normalizeID(groupID);

        if (groupID === '') {
          return null;
        }

        _this24.prevShareGroupID = normalizeID(groupID);
        return _this24.openSocketForShareServer();
      }).finally(function () {
        _this24.shareServerGetting = false;
      });
    ...
    key: "connectToShareServer",
    value: function connectToShareServer(args, util) {
      var _this25 = this;
      ...
      return this.getShareServer().then(function (server) {
        ...
        if (_this25.dataSharingWasCanceled) return 'Data sharing was canceled by user.';
    ...
    value: function sendSharedData(args, util) {
      ...
      return this.getShareServer().then(function (server) {
        ...
        _this26.shareDataSending = true;
        return fetch(_this26.shareServerSendingURL + encodeURIComponent(_this26.shareGroupID), {
          method: 'POST',
          mode: 'cors',
          headers: {
          ...
          body: JSON.stringify({
            groupId: encodeURIComponent(_this26.shareGroupID),
        ...
        return new Promise(function (resolve) {
          setTimeout(function () {
            _this26.shareDataSending = false;
            resolve();
          }, _this26.shareDataSendingIntervalTime);
        });
      }).catch(function (reason) {
        _this26.shareDataSending = false;
        console.info(reason);
    ...
    value: function getSharedDataLabeled(args) {
      ...
      var label = normalizeID(cast.toString(args.LABEL));
    ...
    value: function updatePrevSharedData() {
      ...
      for (var _i3 = 0, _Object$entries = Object.entries(this.sharedData); _i3 < _Object$entries.length; _i3++) {
        var _Object$entries$_i = _slicedToArray(_Object$entries[_i3], 2),
            label = _Object$entries$_i[0],
            contentObject = _Object$entries$_i[1];

        this.prevSharedData[label] = {};

        for (var _i4 = 0, _Object$entries2 = Object.entries(contentObject); _i4 < _Object$entries2.length; _i4++) {
    ...
    value: function whenSharedDataReceived(args) {
      ...
      var label = normalizeID(cast.toString(args.LABEL));
      if (!this.sharedData[label]) return false; // ラベル単位でのタイムスタンプ管理（パフォーマンス最適化）

      if (!this.labelTimestamps) this.labelTimestamps = {};
      var currentTimestamp = this.sharedData[label].timestamp;
      var lastKnownTimestamp = this.labelTimestamps[label]; // 初回データまたはタイムスタンプが異なる場合
    ...
    key: "sendIrRemote",
    value: function () {
      var _sendIrRemote = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee13(args) {
        var n, connectorInput, connectorValues, CONNECTOR, MIN_INTERVAL;
        return regenerator.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
              ...
              case 3:
                ...
                connectorValues = this.getIrRemoteMenuConnector().map(function (item) {
                  return cast.toNumber(item.value);
                });
                ...
                _context13.next = 10;
                return this.board.firmata.sysexCommand([0x03, n]);
    ...
    key: "askGenerativeAI",
    value: function () {
      var _askGenerativeAI = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee14(args) {
        var _this27 = this;

        var content, image_data;
        return regenerator.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                ...
                _context14.next = 4;
                return new Promise(function (resolve) {
                  _this27.runtime.renderer.requestSnapshot(function (imageDataURL) {
                    resolve(imageDataURL);
                  });
                });

              case 4:
                image_data = _context14.sent;
                content.push({
                  "image": {
                    "format": "png",
                    'source': {
                      'bytes': image_data.substring("data:image/png;base64,".length)
                    }
                  }
                });
              ...
              case 6:
                content.push({
                  "text": cast.toString(args.PROMPT)
                });
                return _context14.abrupt("return", this.fetchGenerativeAI({
                  "content": content
                }));
      ...
      function askGenerativeAI(_x11) {
        return _askGenerativeAI.apply(this, arguments);
      }

      return askGenerativeAI;
    }()
  }, {
    key: "fetchGenerativeAI",
    value: function () {
      var _fetchGenerativeAI = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee15(body) {
        var _this28 = this;
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                ...
                return _context15.abrupt("return", Promise.resolve(formatMessage({
              ...
              case 2:
                _context15.next = 4;
                return this.getCachedBoardInfo();

              case 4:
                body['board'] = _context15.sent;
                body['locale'] = formatMessage({
                  id: 'g2s.askGenerativeAILocale',
                  default: 'en',
                  description: 'error message locale'
                });
                url = window.DEBUG_GENERATIVE_AI_URL ? window.DEBUG_GENERATIVE_AI_URL : this.generativeAIURL;
                _context15.next = 9;
                return fetch(url, {
                  mode: 'cors',
                  method: 'POST',
                  ...
                  if (body.content !== null) {
                    ...
                    return '';
                  } else if (_typeof(body.error) == 'object' && typeof body.error.type !== 'undefined' && typeof body.error.content !== 'undefined') {
                    if (body.error.type === 'text/html') {
                      _this28.openErrorDialog(body.error.content);
      ...
      function fetchGenerativeAI(_x12) {
        return _fetchGenerativeAI.apply(this, arguments);
      }

      return fetchGenerativeAI;
    }()
  }, {
    key: "openErrorDialog",
    value: function openErrorDialog(contentHtml) {
      ...
      errorDialog.style.position = 'relative'; // Close button
      ...
      return new Promise(function (resolve) {
        ...
        _this29.errorDialogOpened = false;
      });
    }
  }, {
    key: "connectSpreadsheetAppend",
    value: function () {
      var _connectSpreadsheetAppend = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee16(args) {
        return regenerator.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                _context16.next = 2;
                return this.connectFetch('SpreadsheetAppend', args);
      ...
      function connectSpreadsheetAppend(_x13) {
        return _connectSpreadsheetAppend.apply(this, arguments);
      }

      return connectSpreadsheetAppend;
    }()
  }, {
    key: "connectSpreadsheetWrite",
    value: function () {
      var _connectSpreadsheetWrite = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee17(args) {
        return regenerator.wrap(function _callee17$(_context17) {
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                _context17.next = 2;
                return this.connectFetch('SpreadsheetWrite', args);
      ...
      function connectSpreadsheetWrite(_x14) {
        return _connectSpreadsheetWrite.apply(this, arguments);
      }

      return connectSpreadsheetWrite;
    }()
  }, {
    key: "connectSpreadsheetRead",
    value: function () {
      var _connectSpreadsheetRead = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee18(args) {
        return regenerator.wrap(function _callee18$(_context18) {
          while (1) {
            switch (_context18.prev = _context18.next) {
              case 0:
                _context18.next = 2;
                return this.connectFetch('SpreadsheetRead', args);
      ...
      function connectSpreadsheetRead(_x15) {
        return _connectSpreadsheetRead.apply(this, arguments);
      }

      return connectSpreadsheetRead;
    }()
  }, {
    key: "connectSendLine",
    value: function () {
      var _connectSendLine = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee19(args) {
        return regenerator.wrap(function _callee19$(_context19) {
          while (1) {
            switch (_context19.prev = _context19.next) {
              case 0:
                _context19.next = 2;
                return this.connectFetch('SendLine', args);
      ...
      function connectSendLine(_x16) {
        return _connectSendLine.apply(this, arguments);
      }

      return connectSendLine;
    }()
  }, {
    key: "connectSendMail",
    value: function () {
      var _connectSendMail = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee20(args) {
        return regenerator.wrap(function _callee20$(_context20) {
          while (1) {
            switch (_context20.prev = _context20.next) {
              case 0:
                _context20.next = 2;
                return this.connectFetch('SendMail', args);
      ...
      function connectSendMail(_x17) {
        return _connectSendMail.apply(this, arguments);
      }

      return connectSendMail;
    }()
  }, {
    key: "getCachedBoardInfo",
    value: function () {
      var _getCachedBoardInfo = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee21() {
        var _this30 = this;
          ...
          while (1) {
            switch (_context21.prev = _context21.next) {
              ...
              case 5:
                ...
                setTimeout(function () {
                  _this30.cachedBoardInfo.expired = true;
                }, 10 * 60 * 1000);

              case 9:
                return _context21.abrupt("return", this.cachedBoardInfo.board);
      ...
      function getCachedBoardInfo() {
        return _getCachedBoardInfo.apply(this, arguments);
      }

      return getCachedBoardInfo;
    }()
  }, {
    key: "connectFetch",
    value: function () {
      var _connectFetch = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee22(opcode, args) {
        var _this31 = this;
          ...
          while (1) {
            switch (_context22.prev = _context22.next) {
              ...
              case 3:
                ...
                _context22.t1 = formatMessage({
                  id: 'g2s.askGenerativeAILocale',
                  default: 'en',
                  description: 'error message locale'
                });
                _context22.t2 = _defineProperty({}, opcode, Object.fromEntries(Object.entries(args).filter(function (_ref2) {
                ...
                body = {
                  board: _context22.t0,
                  locale: _context22.t1,
                  block: _context22.t2
                };
                url = window.DEBUG_AKADAKO_CONNECT_URL ? window.DEBUG_AKADAKO_CONNECT_URL : this.akaDakoConnectURL;
                _context22.next = 10;
                return fetch(url, {
                  mode: 'cors',
                  method: 'POST',
                  ...
                  if (typeof body["Ok"] !== 'undefined' && body["Ok"] !== null) {
                    ...
                    return '';
                  } else if (_typeof(body["Err"]) === 'object' && typeof body["Err"]["type"] !== 'undefined' && typeof body["Err"]["content"] !== 'undefined') {
                    if (body["Err"]["type"] === 'text/html') {
                      _this31.openErrorDialog(body["Err"]["content"]);
              ...
              case 13:
                ...
                return _context22.abrupt("return", _context22.t3.message);
      ...
      function connectFetch(_x18, _x19) {
        return _connectFetch.apply(this, arguments);
      }
    ...
    key: "g2sVideoToggle",
    value: function g2sVideoToggle(args) {
      ...
      return {
        ...
        menus: {
          ...
          neoPixelColorMenuSimple: {
            acceptReporters: true,
            items: this.getNeoPixelColorMenu().filter(function (item) {
              return item.value !== 'rainbow';
            })
          },
          neoPixelColorMenu: {
            acceptReporters: true,
    ...
    key: "getNeoPixelShiftColorLoopModeMenu",
    value: function getNeoPixelShiftColorLoopModeMenu() {
      return [{
        text: formatMessage({
    ...
    key: "getNeoPixelColorModeMenu",
    value: function getNeoPixelColorModeMenu() {
      return [{
        text: formatMessage({
...
var getRainbowColor = function getRainbowColor(idx, length, brightness) {
  var lightness = brightness;
  var chromacity = 0.15;
  var hue = idx * 360 / length;
...
var parseColor = function parseColor(color, brightness) {
  var rgb = [0, 0, 0];

  if (typeof color === 'string') {
    if (color.includes(',')) {
      var nums = color.split(/\s*,\s*/).map(cast.toNumber);
      rgb[0] = nums[0] || 0;
      rgb[1] = nums[1] || 0;
      rgb[2] = nums[2] || 0;
    } else if (/^0x[0-9a-fA-F]+$/.test(color)) {
      var colorNumber = Math.round(cast.toNumber(color));
    ...
    var _colorNumber = Math.round(cast.toNumber(color));

    if (0 <= _colorNumber && _colorNumber <= 0xffffff) {
      rgb[0] = (_colorNumber & 0xff0000) >> 16;
      rgb[1] = (_colorNumber & 0x00ff00) >> 8;
      rgb[2] = (_colorNumber & 0x0000ff) >> 0;
    }
...
var normalizeID = function normalizeID(s) {
  return toHankakuAlnum(s.trim());
};
/**
 * 全角数字を半角数字に変換する
 * @param {string} s 文字列
...
var toHankakuAlnum = function toHankakuAlnum(s) {
  return s.replace(/[\uFF10-\uFF19\uFF21-\uFF3A\uFF41-\uFF5A]/g, function (m) {
